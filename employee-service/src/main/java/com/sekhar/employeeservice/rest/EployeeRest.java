package com.sekhar.employeeservice.rest;
...
public class EployeeRest {

	@Autowired
	private EmployeeService employeeService;

	@PostMapping
	public ResponseEntity<EmployeeDto> employeeService(@RequestBody EmployeeDto employeeDto) {
	...
	public ResponseEntity<APIResponse> getEmployee(@PathVariable Long employeeId) {
		APIResponse apiResonse = employeeService.getEmployeeById(employeeId);
